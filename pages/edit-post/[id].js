...
export default function Post() {
  ...
  async function fetchPost() {
    ...
    const contract = new ethers.Contract(contractAddress, DecentraBlog.abi, provider)
  ...
  async function updatePost() {
    ...
    const contract = new ethers.Contract(contractAddress, DecentraBlog.abi, signer)
